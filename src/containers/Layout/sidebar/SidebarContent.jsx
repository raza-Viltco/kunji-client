  ...
  return (
    <div className="sidebar__content">
      <ul className="sidebar__block">
        ...
        />
            <SidebarLink
          title="Markket Place for Product and Services"
          icon="heart-pulse"
        ...
        />
          ...
          title="Complaint"
          icon="bubble"   
          route="/ui/typography"       // route="/fitness_dashboard"
          // onClick={hideSidebar}
        />
            <SidebarLink
          title="Facilities Membership/booking"
          icon="envelope"          route="/forms/form_validation"
          // route="/fitness_dashboard"
          // onClick={hideSidebar}
        />
